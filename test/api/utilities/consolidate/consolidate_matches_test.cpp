...
struct consolidate_matches : public app_test
{
...
TEST_F(consolidate_matches, bins8overlap50)
{
    ...
    auto expected = valik::read_alignment_output<valik::stellar_match>(app_test::data("stellar_truth.gff"), reference, std::ios::binary);
...
TEST_F(consolidate_matches, bins16overlap50)
{
...
TEST_F(consolidate_matches, with_options_bins8overlap50filter)
{
    size_t number_of_bins = 8;
    size_t segment_overlap = 50;

    valik::search_arguments arguments{};
    arguments.query_file = app_test::data("multi_seq_query.fasta");
    arguments.ref_meta_path = consolidation_meta_path(number_of_bins, segment_overlap);
    arguments.all_matches = consolidation_input_path(number_of_bins, segment_overlap);
...
TEST_F(consolidate_matches, with_options_bins16overlap50filter)
{
    size_t number_of_bins = 16;
    size_t segment_overlap = 50;
