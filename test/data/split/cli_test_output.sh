...
do
    ...
    do
        ...
        valik split "$seg_input" --overlap "$o" --bins "$b" --db-meta "$ref_meta" --seg-meta "$seg_meta"
    done
done
...
do
    ...
    valik split "$ref_input" --overlap "$seg_overlap" --bins "$b" --db-meta "$ref_meta" --seg-meta "$seg_meta"
