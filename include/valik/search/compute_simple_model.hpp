...
inline threshold make_threshold_data(search_arguments const & arguments)
{
    ...
    threshold_data.kmers_per_window = arguments.window_size - arguments.shape.count() + 1;
    threshold_data.kmers_per_pattern = arguments.pattern_size - arguments.shape.count() + 1;
    ...
    threshold_data.kmer_lemma = arguments.pattern_size + 1u > (arguments.errors + 1u) * arguments.shape.count() ?
                    arguments.pattern_size + 1u - (arguments.errors + 1u) * arguments.shape.count() : 0;
