...
void valik_split(split_arguments const & arguments)
{
    ...
    // Write segment sequences into separate FASTA files
    ...
    int i = 0;
    for (auto && [seq] : sequence_file_t{arguments.ref_file})
    {
        ...
        {
            std::filesystem::path seg_file = arguments.ref_file;
            ...
            seqan3::sequence_file_output fout{seg_file};
